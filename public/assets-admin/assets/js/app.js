    ...
    a("#side-menu").metisMenu(),
        ...
        a(window).on("load", function () {
            a(".switch").on("switch-change", function () {
                ...
                991 <= window.innerWidth && window.innerWidth <= 1024 && (document.body.setAttribute("data-sidebar-size", "sm"), l("sidebar-size-small"));
        }),
        ...
        n.hasAttribute("data-layout") && "horizontal" == n.getAttribute("data-layout") ? (l("layout-horizontal"), a(".sidebar-setting").hide()) : l("layout-vertical"),
        n.hasAttribute("data-bs-theme") && "dark" == n.getAttribute("data-bs-theme") ? l("layout-mode-dark") : l("layout-mode-light"),
        n.hasAttribute("data-layout-size") && "boxed" == n.getAttribute("data-layout-size") ? l("layout-width-boxed") : l("layout-width-fuild"),
        n.hasAttribute("data-layout-scrollable") && "true" == n.getAttribute("data-layout-scrollable") ? l("layout-position-scrollable") : l("layout-position-fixed"),
        n.hasAttribute("data-topbar") && "dark" == n.getAttribute("data-topbar") ? l("topbar-color-dark") : l("topbar-color-light"),
