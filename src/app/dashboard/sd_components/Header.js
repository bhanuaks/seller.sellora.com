        ...
        <div className="col-lg-12">
          <div className="nav-and-btn-wrapper">
            ...
            <div className="nav-area dash_board_top_menu">
              <nav>
                <ul>
                  {/* <li class="parent"> <a href={`${baseUrl}dashboard`}>Home</a> </li> */}
                  ...
                  <li className="parent"> 
                    <Link href={`${baseUrl}dashboard/advertising`}>Advertising</Link> 
                  </li>
                  <li className="parent"> 
            ...
            <div className="right-btn-area right-btn-area2 header-five">
              ...
              <div className="menu_right2">
                ...
                {/* <a href="#"><i class="fa-light fa-bell"></i> Aahil Mart </a>  */}
              </div>
