...
function Page() {
  ...
  <div className="details_page_outer">
                  ...
                  <tbody>
                    <tr className="winner__table rightselect3">
                      ...
                      <td style={{ minWidth: 80 }}>
                            ...
                            <Image src={`${baseUrl}front/assets/images/preview01`}
                                        alt=''
                                        width={0}
                                        height={0}
                                        sizes='100vw'
    ...
    <div className="container pt-80">
      <div className="row">
        {/* <div class="col-12">
              <div class="outerhead1">
                  <h2>Choose the creative type for your advertisement</h2>
              </div>
          </div> */}
        {/* <div class="col-lg-6 col-12">
              <div class="row adverCheck">
                  <div class="col-md-3 col-6">
                      <div class="d-flex align-items-center">
                          <input id="cb1" class="checkbox" type="checkbox">
                          <span class="ps-3"> Auto Creative</span>
                      </div>
                  </div>
                  <div class="col-md-3 col-6">
                      <div class="d-flex align-items-center">
                          <input id="cb1" class="checkbox" type="checkbox" checked>
                          <span class="ps-3"> Auto Creative</span>
                      </div>
                  </div>
              </div>
              ...
              <div className="box2">
                <div className="video-custom position-relative">
                  <div className="play-pause">
                   ...
                   <Image src={`${baseUrl}front/assets/images/0001.jpg`}
                                        alt=''
                                        width={0}
                                        height={0}
                                        sizes='100vw'
                                        ...
                                        style={{width:"auto", height:"auto"}}
                                        /> 
                  {/* <iframe class="iframeVideo" src="assets/images/0001.png"
