    ...
    <div className="details_page_outer">
      <div className="container">
        <div className="row">
          ...
          <div class="explore_button"><a href="#">Explore Offer</a></div> */}
            </div>
          </div>
          <div className="col-lg-4">
            <div className="boxs_1 adver_boxs">
              ...
              {/* <div class="explore_button"><a href="#">Explore What's New</a></div> */}
            </div>
          </div>
          <div className="col-lg-4">
            <div className="boxs_1 adver_boxs">
              ...
              {/* <div class="explore_button"><a href="#">Explore Review</a></div> */}
            </div>
          </div>
          <div className="col-lg-4">
            <div className="boxs_1 adver_boxs">
    ...
    <div className="container">
      <div className="breadcrumb-inner">
        <div className="adver-bottom-content">
          ...
          {/* <p class="text-white">Start Your Advertising Journey: Reach More, Sell and Growth</p> */}
        </div>
