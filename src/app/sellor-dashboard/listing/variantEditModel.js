...
const VariantEditModel = ({ openModel, closeVariantModal, productVariant, refreshList, setRefreshList, thresholdData, setThresholdData }) => {
  const {globalData, setGlobalData} = useContext(AppContext)
    ...
    useEffect(() => {
        if (productVariant) {
            fetch(`${baseUrl}api/sellor/product/get-variant`, {
                method: "POST",
                body: JSON.stringify({
    ...
    function saveVariantEditData(e) {
        ...
        fetch(`${baseUrl}api/sellor/product/update-and-copy-variant`, {
            method: "POST",
            body: JSON.stringify({
                ...variantData,
                    ...
                    <div className="col-lg-3">
                      <input type="text" placeholder="Lora s Choice" />
                                    ...
                                    <div className="save_all">
                                        <span type='button' href="#" onClick={() => closeVariantModal()} className='mr-3 cencel_button'>Cencel</span>
