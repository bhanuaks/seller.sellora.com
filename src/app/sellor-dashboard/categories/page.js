...
const page = ({params}) => {
  ...
  const searchCategorySubmit=(e)=>{
    e.preventDefault();
    const link = `${baseUrl}sellor-dashboard/categories?search=${searchText}`
    setSelectCategory({
      category:'',
      category_id:'',
      category_slug:'',
  ...
  const selectBrand=(e)=>{
    ...
    const link = `${baseUrl}sellor-dashboard/brand-choose?category=${selectCategory.category_id}&subCategory=${selectCategory.subcategory_id}&childcategory=${selectCategory.childcategory_id}`
          ...
          <div className="col-lg-6 col-md-6">
            <div className="navigator-breadcrumb-wrapper seller-central-dash-board-breadcrumb">
              <ul>
                ...
                <li><a href="#"><i className="fa-solid fa-video"></i>Learn How to do Listing</a> </li>
              </ul>
            </div>
          </div>
        </div>
                ...
                :null}
                    ...
                    <div className="col-lg-12">
                      ...
                      <ul>
                        ...
                        <div className="select_btn" ref={brandRef}><Link href={`${baseUrl}sellor-dashboard/brand-choose`} onClick={(e)=>selectBrand(e)}>Select Brand</Link></div> 
