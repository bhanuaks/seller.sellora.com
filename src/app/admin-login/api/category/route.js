...
import PackageBreadth from '../../../../../lib/variant/PackageBreadthModel';
import PackageHeight from '../../../../../lib/variant/PackageHeightModel';
import PackageLength from '../../../../../lib/variant/PackageLengthModel';
...
export async function POST(req) {
  try {
    ...
    //   const uploadsDir = path.join(process.cwd(), 'public', 'uploads/category/list');
    ...
    //   photoPath = `/uploads/category/list/${photoFilename}`;

    //   if (id) {
    //     const oldPhotoPath = path.join(process.cwd(), 'public', photo);
