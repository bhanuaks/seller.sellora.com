...
const page = () => {
  ...
  useEffect(() => {
    if (globalData.sellor) {
      ...
      fetch(`${baseUrl}api/sellor/get-profile?user_id=${globalData.sellor._id}&with_data=shippingSetting`, {
        method: "GET",
      }).then((response) => {
        if (!response.ok) {
...
const updateInputData= (e)=>{
  ...
  function submitUpdateForm(e) {
    ...
    setErrors({});
    $('.loaderouter').css('display', 'flex'); 
    fetch(`${baseUrl}api/sellor/update-profile?update=shippingSetting`, {
      method: "POST",
      ...
      if (res.status) {
        ...
        if(shippingSetting.shipping_setting==1){ 
          ...
          router.push('/sellor/al/shipping-setting/creating-shipping-template')
        }
      ...
      <div className="col-lg-6">
        ...
        <form action={'#'} onSubmit={(e)=>submitUpdateForm(e)}>  
          <div className="row">
            ...
            {/* <Link href="/sellor/al/shipping-setting/creating-shipping-template"> */}
