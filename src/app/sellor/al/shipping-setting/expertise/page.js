...
const page = () => {
  ...
  useEffect(()=>{ 
    if(globalData.sellor){
      ...
      fetch(`${baseUrl}api/sellor/get-profile?user_id=${globalData.sellor._id}&with_data=ExpertiseShippingTemplete`,{
        method:"GET", 
      }).then((response)=>{
          if(!response.ok){
...
function submitUpdateForm(e){
  ...
  $('.loaderouter').css('display','flex');
  fetch(`${baseUrl}api/sellor/create-shipping-templete`,{
    method:"POST",
    ...
    $('.loaderouter').css('display','none') 
      if(res.status){
        ...
        router.push('/sellor/al/bank-account-information')
                        ...
                        <td colSpan={5}>
                          <div className="table_menu">
                            <ul className="expanded">
                              <li>
                                <Link
                                  href="/sellor/al/shipping-setting/creating-shipping-template" 
                                >
                                  Standard
                                </Link>
                              </li>
                              <li className="active current">
                                <Link className='active' href="/sellor/al/shipping-setting/expertise">Expertise</Link>
                              </li>
                            </ul>
                          </div>
                        </td>
