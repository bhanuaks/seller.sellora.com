...
const page = () => {
  ...
  useEffect(()=>{ 
    if(globalData.sellor){
      ...
      fetch(`${baseUrl}api/sellor/get-profile?user_id=${globalData.sellor._id}&with_data=standerdShippingTemplete`,{
        method:"GET", 
      }).then((response)=>{
          if(!response.ok){
  ...
  fetch(`${baseUrl}api/sellor/create-shipping-templete`,{
    ...
    $('.loaderouter').css('display','none') 
      if(res.status){
        ...
        router.push('/sellor/al/shipping-setting/expertise')
                          ...
                          <div className="table_menu">
                            <ul className="expanded">
                              ...
                              <li className="active current">
                                <Link href="/sellor/al/shipping-setting/expertise">Expertise</Link>
                              </li>
                            </ul>
                          </div>
                        </td>
