...
function page() {
  ...
  useEffect(() => {
    if (globalData.sellor) {
      ...
      fetch(
        `${baseUrl}api/sellor/get-profile?user_id=${globalData.sellor._id}&with_data=businessDetails`,
        {
          method: "GET",
        }
      )
  ...
  function submitUpdateForm(e) {
    ...
    fetch(`${baseUrl}api/sellor/update-profile?update=businessDetails`, {
      method: "POST",
      body: formData,
    })
      .then((response) => {
      ...
      .then((res) => {
        ...
        if (res.status) {
          ...
          router.push("/sellor/al/tax-information");
