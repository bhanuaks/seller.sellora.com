            ...
            <nav className="nav-main mainmenu-nav mt--30">
              <ul className="mainmenu metismenu" id="mobile-menu-active">
                <li className="parent">
                  ...
                  <Link href="sell-online.html">Sell Online</Link>
                </li>
                <li className="parent">
                  <Link href="fees-n-commission.html">Fees &amp; Commission</Link>
                </li>
                <li className="parent">
                  <Link href="grow.html">Grow</Link>
                </li>
                <li className="parent">
                  <Link href="learn.html">Learn</Link>
                </li>
              </ul>
            </nav>
          </div>
        ...
        {/*   <div class="tab-pane fade" id="nav-profile" role="tabpanel" aria-labelledby="nav-profile-tab"
              ...
              <div class="category-btn category-hover-header menu-category">
                  <ul class="category-sub-menu" id="category-active-menu">
                      ...
                      <li class="parent"> <Link href="career.html">Careers</Link> </li>
                      <li class="parent"> <Link href="about-us.html">About Sellora</Link> </li>
                      <li class="parent"><Link href="culture.html">Culture</Link></li>
                      <li class="parent"><Link href="jobs.html">Jobs</Link></li>
