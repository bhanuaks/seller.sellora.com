   ...
   useEffect(() => {
          ...
          if (input) {
            const iti = intlTelInput(phoneInputRef.current, {
              initialCountry: sellerData && sellerData.country_s_name?sellerData.country_s_name:'in',
    ...
    $('.loaderouter').css('display','flex')
      fetch(`${baseUrl}api/front/seller-register`,{
        ...
        if(res.status){
          ...
          setTimeout(() => { 
            // route.push(`${baseUrl}sellor/login`)
            window.location.href=`${baseUrl}sellor/al/contact-details`
          }, 600);
                ...
                >
                  ...
                  <div className="input-wrapper job-input-wrapper">
                    <div className="row align-items-center">
                      ...
                      <div className={`col-lg-${sendedOtp?"3":"2"} col-${sendedOtp?"3":"2"} p0 m0`}><div className="send_otp">
