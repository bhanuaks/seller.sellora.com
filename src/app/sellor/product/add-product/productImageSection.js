...
const ProductImageSection = ({ productDetails, 
    setProductDetails, 
    image, 
    setImage, 
    imagePath, 
              ...
              if (file.size > 10 * 1024 * 1024) {
                ...
                reader.onload = () => {
                    ...
                    img.onload =()=>{
                        ...
                        if(width < 1600 ){
                            alert("Image must be at least 1600px in width and height."); 
                            if (imageRef.current) {
                                imageRef.current.value = "";  
    ...
    return (
        <div className="uploaded_images">
            <div className="uplaod_image_heading">
                <h2>Uploaded Images<span>*</span> <small style={{fontSize:'12px'}}>(upload 4 images)</small> </h2>
            </div>
            <div className="row">
                        ...
                        <div className="col-lg-4" key={index}>
                                <div className="image_box">
                                    <div className="remove">
                                        <a href="#" onClick={(e)=>deleteImage(e, index)} title='Remove image'>
