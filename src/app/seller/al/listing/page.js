              ...
              <div className="row">
                <div className="col-lg-8 offset-lg-2">
                  <div className="nnn_dform">
                    ...
                    <Link className="save" href={`${baseUrl}dashboard/add-catalog`} >Search the Sellora catalog</Link>
                    <div className="mt--40">
                      <h3 className="text-center">
                        Have You Launched a New Product?
                      </h3>
                      <Link className="border_save"  href={`${baseUrl}dashboard/add-catalog`} >List Your Product</Link>
                    </div>
                  </div>
                </div>
              </div>
