...
const page = () => {
  ...
  useEffect(()=>{ 
    if(globalData.sellor){
      ...
      fetch(`${baseUrl}api/seller/get-profile?user_id=${globalData.sellor._id}&with_data=standerdShippingTemplete`,{
        method:"GET", 
      }).then((response)=>{
          if(!response.ok){
  ...
  fetch(`${baseUrl}api/seller/create-shipping-templete`,{
    ...
    $('.loaderouter').css('display','none') 
      if(res.status){
        ...
        router.push('/seller/al/shipping-setting/expertise')
                          ...
                          <div className="table_menu">
                            <ul className="expanded">
                              ...
                              <li className="active current">
                                <Link href="/seller/al/shipping-setting/expertise">Expertise</Link>
                              </li>
                            </ul>
                          </div>
                        </td>
