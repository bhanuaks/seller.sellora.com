          ...
          <div className="row">
            <div className="col-lg-7">
              <div className="content_dashboar_6">
                ...
                <p>
                  Enjoy 0% Commission &amp; fees for the limited time when you
          ...
          <div class="accordion-body"> Sign up for a seller account at the Sellora website and fill out the registration form with all your business information.
            Once your account is verified, you can start adding your products. </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        Pay outs for the sold products are passed securely
                        through Selloras payment interface. After deducting the
                        fees that are applicable, the amount of earnings will be
                        transferred to the account of your bank according to the
                        schedule specified.
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="accordion-item">
                    ...
                    >
                      <div className="accordion-body">
                        ...
                        understand Selloras return guidelines to ensure
                      ...
                      <div className="accordion-body">
                        ...
                        <ul className="list_457">
                          <li>
                            ...
                            meets the conditions for a refund under Selloras
                            policy.
                          </li>
                          <li>
