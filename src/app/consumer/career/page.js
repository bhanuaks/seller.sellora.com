...
const page = () => {
  ...
  <section>
    ...
    >
      ...
      {/* <Link class="carousel-control-prev" href="#carouselExampleFade" role="button" data-slide="prev">
          <span class="carousel-control-prev-icon" aria-hidden="true"></span>
          <span class="sr-only">Previous</span>
      </Link>
      <Link class="carousel-control-next" href="#carouselExampleFade" role="button" data-slide="next">
      ...
      <div className="social-and-payment-area-wrapper social-career-list social-career-list2 social-list">
        <div className="social-one-wrapper social-two-wrapper">
          ...
          <ul>
            ...
            {/* <li><Link href="#"><i class="fa-brands fa-youtube"></i></Link></li> */}
            <li>
              <Link href="#">
        ...
        {/* <div class="payment-access"> <span>Payment Accepts:</span> <img src={`${baseUrl}front/assets/images/payment/06.png`} alt=""> </div> */}
      </div>
    </div>
  </section>
      ...
      <div className="row justify-content-center ">
        ...
        >
          <div className="career-content">
            {/* <h4 class="bighd">Meet Our Team</h4> */}
            <p>
